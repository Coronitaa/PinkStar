...
const baseGames: Game[] = [
  {
    ...
    bannerUrl: 'https://placehold.co/1200x400/D81B60/FFFFFF?text=PixelVerse+Wide+Banner',
  ...
  },
  {
    ...
    bannerUrl: 'https://placehold.co/1200x400/AD1457/FFFFFF?text=Galaxy+Wide+Banner',
  ...
  },
  {
    ...
    bannerUrl: 'https://placehold.co/1200x400/F06292/FFFFFF?text=Kingdoms+Wide+Banner',
...
const allResources: Resource[] = [
  ...
  },
  {
    ...
    imageGallery: [
        'https://placehold.co/800x600/F48FB1/121212?text=Minimap+Settings&data-ai-hint=ui options',
        'https://placehold.co/800x600/EC407A/FFFFFF?text=Minimap+Cave+Mode&data-ai-hint=gameplay underground',
    ],
    ...
    files: [
      { id: 'file2_1', name: 'advanced-minimap-v3.5.2-fabric.jar', url: '#', size: '1.2 MB', supportedVersions: [commonTags.v1_19, commonTags.v1_20, commonTags.v1_20_1, commonTags.v1_20_4], supportedLoaders: [commonTags.fabric], channel: commonTags.channelRelease, date: '2024-03-01T11:00:00Z' }, 
      { id: 'file2_2', name: 'advanced-minimap-v3.5.2-forge.jar', url: '#', size: '1.3 MB', supportedVersions: [commonTags.v1_19, commonTags.v1_20, commonTags.v1_20_1, commonTags.v1_20_4], supportedLoaders: [commonTags.forge], channel: commonTags.channelRelease, date: '2024-03-01T11:00:00Z' },
      { id: 'file2_3', name: 'advanced-minimap-v3.5.0-neoforge.jar', url: '#', size: '1.3 MB', supportedVersions: [commonTags.v1_20_1], supportedLoaders: [commonTags.neoForge], channel: commonTags.channelBeta, date: '2024-01-15T10:00:00Z' }
    ], 
  ...
  },
  {
    ...
    imageGallery: [
        'https://placehold.co/800x600/880E4F/FFFFFF?text=Skyblock+Start&data-ai-hint=floating island',
        'https://placehold.co/800x600/C2185B/FFFFFF?text=Skyblock+Nether+Island&data-ai-hint=nether biome',
    ],
    ...
    files: [{ id: 'file3_1', name: 'skyblock-odyssey-v1.0.zip', url: '#', size: '10.2 MB', supportedVersions: [commonTags.v1_20], supportedLoaders: [], channel: commonTags.channelRelease, date: '2023-07-01T12:00:00Z' }], 
  ...
  },
  {
    ...
    imageGallery: [
        'https://placehold.co/800x600/AD1457/FFFFFF?text=Nebula+Skin&data-ai-hint=spaceship skin',
        'https://placehold.co/800x600/C2185B/FFFFFF?text=Engine+Trails&data-ai-hint=visual effect',
        'https://placehold.co/800x600/880E4F/FFFFFF?text=Starfighter+View&data-ai-hint=cockpit view',
    ],
    ...
    files: [{ id: 'file4_1', name: 'cosmic-galaxy-pack-v1.5.0.pak', url: '#', size: '25.5 MB', supportedVersions: [], supportedLoaders: [], channel: commonTags.channelRelease, date: '2023-08-25T14:30:00Z' }], 
  ...
  },
  {
    ...
    imageGallery: [
        'https://placehold.co/800x600/EC407A/FFFFFF?text=Sorted+Chest&data-ai-hint=ui inventory',
        'https://placehold.co/800x600/F06292/121212?text=Sort+Options&data-ai-hint=settings menu',
    ],
    ...
    files: [{ id: 'file5_1', name: 'inventory-sorter-v1.8.0.jar', url: '#', size: '0.5 MB', supportedVersions: [commonTags.v1_20, commonTags.v1_21], supportedLoaders: [commonTags.fabric], channel: commonTags.channelRelease, date: '2023-09-10T00:00:00Z' }], 
  ...
  },
  {
    ...
    imageGallery: [
        'https://placehold.co/800x600/F06292/121212?text=Realistic+Wood&data-ai-hint=texture wood',
        'https://placehold.co/800x600/E91E63/FFFFFF?text=HD+Stone&data-ai-hint=texture stone',
        'https://placehold.co/800x600/D81B60/FFFFFF?text=Realistic+Water&data-ai-hint=water shader',
    ],
    ...
    files: [
      { id: 'file6_1', name: 'realistic-textures-hd-v4.2.0_256x.zip', url: '#', size: '150 MB', supportedVersions: [commonTags.v1_20, commonTags.v1_21], supportedLoaders: [], channel: commonTags.channelAlpha, date: '2023-07-20T00:00:00Z' }, 
      { id: 'file6_2', name: 'realistic-textures-hd-v4.2.0_128x.zip', url: '#', size: '80 MB', supportedVersions: [commonTags.v1_20, commonTags.v1_21], supportedLoaders: [], channel: commonTags.channelRelease, date: '2023-07-20T00:00:00Z' }
    ], 
  ...
  ...Array.from({ length: 25 }, (_, i) => ({
    ...
    imageUrl: `https://placehold.co/600x400/7B1FA2/FFFFFF?text=Util-${i + 1}&data-ai-hint=abstract icon`,
    imageGallery: [
        `https://placehold.co/800x600/7B1FA2/FFFFFF?text=Util-${i + 1}-Feature1&data-ai-hint=gameplay feature`,
        `https://placehold.co/800x600/8E24AA/FFFFFF?text=Util-${i + 1}-Feature2&data-ai-hint=ui element`,
    ],
    author: authors[i % 3],
    ...
    files: [{ id: `file-pv-util-${i+7}`, name: `utility-mod-${i+1}.jar`, url: '#', size: '0.2MB', supportedVersions: [commonTags.v1_20], supportedLoaders: [(i % 2 === 0 ? commonTags.fabric : commonTags.forge)], channel: i % 3 === 0 ? commonTags.channelRelease : (i % 3 === 1 ? commonTags.channelBeta : commonTags.channelAlpha), date: new Date(Date.now() - Math.random() * 1000 * 60 * 60 * 24 * 7 * (i + 1)).toISOString() }],
  ...
  })),
  {
    ...
    imageUrl: 'https://placehold.co/600x400/880E4F/FFFFFF?text=PVPlaza+Overview&data-ai-hint=city map',
    imageGallery: [
        'https://placehold.co/800x600/880E4F/FFFFFF?text=Plaza+Fountain&data-ai-hint=fountain plaza',
        'https://placehold.co/800x600/C2185B/FFFFFF?text=Market+Stalls&data-ai-hint=market scene',
    ],
    ...
    files: [{ id: 'file-pv-map-extra', name: 'pv-grand-plaza.zip', url: '#', size: '15.2 MB', supportedVersions: [commonTags.v1_21], supportedLoaders: [], channel: commonTags.channelRelease, date: new Date('2023-10-05T18:00:00Z') }],
  ...
  },
   {
    ...
    imageUrl: 'https://placehold.co/600x400/C2185B/FFFFFF?text=AdvNav+HUD&data-ai-hint=hud ui',
    imageGallery: [
        'https://placehold.co/800x600/C2185B/FFFFFF?text=Nav+System+UI&data-ai-hint=space ui',
        'https://placehold.co/800x600/AD1457/FFFFFF?text=Targeting+Reticule&data-ai-hint=crosshair target',
    ],
    ...
    files: [{ id: 'file-ge-nav-1', name: 'ge-ans-v2.2.0.pak', url: '#', size: '8.1 MB', supportedVersions: [], supportedLoaders: [], channel: commonTags.channelRelease, date: '2023-09-05T14:30:00Z' }], 
  ...
  },
  {
    ...
    imageUrl: 'https://placehold.co/600x400/E91E63/FFFFFF?text=Smart+AI&data-ai-hint=ai brain',
    imageGallery: [
        'https://placehold.co/800x600/E91E63/FFFFFF?text=AI+Formations&data-ai-hint=army strategy',
        'https://placehold.co/800x600/D81B60/FFFFFF?text=AI+Base+Management&data-ai-hint=rts base',
    ],
    ...
    files: [{ id: 'file-kc-ai-1', name: 'kc-eta-v1.3.0.mod', url: '#', size: '3.5 MB', supportedVersions: [], supportedLoaders: [], channel: commonTags.channelAlpha, date: '2023-08-10T00:00:00Z' }], 
...
export const getGameStats = async (gameSlug: string): Promise<{ totalResources: number; totalDownloads: number; totalFollowers: number }> => {
  ...
  return delayed({ totalResources, totalDownloads, totalFollowers });
};

export const getGamesWithDetails = async (): Promise<(Game & { categories: Category[], stats: {totalResources: number, totalDownloads: number, totalFollowers: number} })[]> => {
...
export const getResources = async (params: GetResourcesParams): Promise<PaginatedResourcesResponse> => {
  ...
  paginatedResources.forEach(resource => {
    ...
    // Ensure files are sorted by date descending if they exist
    if (resource.files) {
