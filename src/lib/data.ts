...
const allResources: Resource[] = [
  ...
  ...Array.from({ length: 25 }, (_, i) => ({
    ...
    detailedDescription: `This is Utility Mod ${i + 1}. It helps with various things like item management, information display, or minor gameplay tweaks. It is designed to be lightweight and compatible with most other mods. Essential utility for players.`,
